...
const addTodoString =
  'Add Todo<button class="add-btn-header"><span>+</span> Add Task</button>';
const todayTodoString =
  'Today<button class="add-btn-header"><span>+</span> Add Task</button>';
